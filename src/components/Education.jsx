...
const Education = () => {
  return (
    <div className='bg-black text-white h-screen flex flex-col items-center'>
      <h1 className='text-center text-5xl pt-20 border-b-2'>Education</h1>
       <div className='flex justify-center gap-5 mt-20   h-96'>
         ...
         <div className='border border-blue-500 relative'>
          <span className='absolute w-5 bg-blue-500 h-5 rounded-full right-[-12px] top-[22%]'></span>
          <span className='absolute w-5 bg-blue-500 h-5 rounded-full right-[-12px] top-[72%]'></span>
         </div>
